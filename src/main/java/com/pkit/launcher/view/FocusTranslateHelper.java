...
/**
 * Created by jiaxing on 2015/5/5.
 */
public class FocusTranslateHelper {
    ...
    static class FocusAnimator implements TimeAnimator.TimeListener {
        ...
        void setFocusLevel(float level) {
            ...
            mView.setTranslationY(scale * 40);
        }
    ...
    public static void setupFragmentItemFocus(MainActivity activity, int zoomIndex) {
        activity.setFocusScale(new BrowseItemFocusHighlight(zoomIndex));
    }
}
